...
model_save_path = "save/model_checkpoint_class20_llrr_v14.tar"  
train_losses = []
eval_losses = []
...
for name, param in model.named_parameters():
    weights_dict[name] = param.data.cpu().numpy()  # 将权重移动到CPU并转换为numpy数组
