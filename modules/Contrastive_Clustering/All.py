...
epochs = 2000  # 增加训练周期
temperature = 0.1  # 调整temperature参数
batch_size = 512  # 增加batch size
learning_rate = 0.0001  # 减少学习率
dataset_path = "./normalized_hsl_features"
model_save_path = "save/model_checkpoint_class20_hsl530.tar"  # 设置模型保存路径
